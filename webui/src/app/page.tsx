...
export default function Home() {
  ...
  const features = [
    ...
    },
    {
      ...
      icon: (
        <DeviceHubIcon sx={{ fontSize: 40 }} className="text-primary dark:text-primary-light" />
      ),
    },
    {
      ...
      <footer className="py-6 px-6 border-t border-light-border dark:border-dark-border">
        <div className="max-w-6xl mx-auto text-center">
          <Typography variant="body2" className="text-gray-500 dark:text-gray-400">
            ...
            logo are registered trademarks of Redis Ltd. Apache Kvrocks Controller is released under
